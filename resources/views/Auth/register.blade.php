    ...
    <body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-white min-h-screen flex items-center justify-center">
        <div class="max-w-md w-full space-y-6">
            <div class="text-center">
                <h2 class="text-2xl font-bold text-[#1b1b18] dark:text-white mb-4">สมัครสมาชิก</h2>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div>
                        <label for="name" class="block text-sm font-medium text-[#1b1b18] dark:text-white mb-2">
                            ชื่อ
                        </label>
                        <input 
                            type="text" 
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-[#1b1b18] dark:text-white mb-2">
                            ยืนยันรหัสผ่าน
                        </label>
                        <input 
                            type="password" 
                ...
                <div class="text-center mt-6">
                    <p class="text-sm text-[#1b1b18] dark:text-white">
                        มีบัญชีแล้ว? 
                        <a href="{{ route('login') }}" class="text-blue-600 underline hover:text-blue-700">
                            เข้าสู่ระบบ
                        </a>
                    </p>
                </div>
