    ...
    <div class="container">
        ...
        <div class="info-row">
            ...
            <div class="info-value">
                <span style="background-color: {{ $leaveRequest->leave_type === 'ลากิจ' ? '#fff3cd' : '#f8d7da' }}; 
        ...
        <div class="info-row">
            ...
            <div class="info-value">{{ $leaveRequest->leave_date->format('d/m/Y') }} ({{ $leaveRequest->leave_date->locale('th')->translatedFormat('l') }})</div>
        </div>

        @if($leaveRequest->duration_type === 'ชั่วโมง' && $leaveRequest->start_time && $leaveRequest->end_time)
        <div class="info-row">
            <div class="info-label">🕐 เวลา:</div>
            <div class="info-value">{{ $leaveRequest->start_time->format('H:i') }} - {{ $leaveRequest->end_time->format('H:i') }} น.</div>
        </div>
        @endif
