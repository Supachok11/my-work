...
return [
    ...
    */
    ...
    'brand' => [
        // 'logo' => resource_path('/img/leave-portal-logo.svg'),
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure theme settings for Nova.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This configuration option allows you to enable breadcrumbs in Nova.
    |
    */
